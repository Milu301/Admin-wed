...
export default function Cash() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Success msg */}
      {successMsg && (
        <div className="px-4 py-3 bg-success/10 border border-success/30 rounded-xl text-success text-sm animate-slide-in">
          ✓ {successMsg}
        </div>
      )}
      ...
      <div className="bg-surfaceCard border border-border rounded-xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-border">
          <h3 className="font-semibold text-textPrimary text-sm">
            Movimientos — {new Date(date + 'T12:00:00').toLocaleDateString('es-MX', { weekday: 'long', day: 'numeric', month: 'long' })}
          </h3>
